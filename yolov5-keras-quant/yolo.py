...
from train import MDQC_4bits, MDQC_8bits, apply_quantization
...
class YOLO(object):
    ...
    def generate(self):
        ...
        with quantize_scope({'MDQC_4bits': MDQC_4bits, 'MDQC_8bits': MDQC_8bits, "Focus": Focus, "SiLU": SiLU}):
            ...
            self.yolo_model = quantized_model

            # self.yolo_model.load_weights('model_data/yolov5s_quant.h5')
            self.yolo_model.load_weights('logs/best_epoch_weights.h5')
